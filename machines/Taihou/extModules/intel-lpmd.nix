  ...
  perStateSubmodule = {
    options = {
      ...
      EPP = lib.mkOption {
        ...
        type = with lib.types;  numbers.between 0 255;
      };
      ...
      EPB = lib.mkOption {
        ...
        type = with lib.types;  numbers.between 0 15;
      };
  ...
  xmlSubmodule = {
    options = {
      ...
      EntryHystMS = lib.mkOption {
        ...
        type = with lib.types; enum ["0" ints.unsigned];
      };
      ...
      lp_mode_epp = lib.mkOption {
        ...
        type = with lib.types; enum[ null numbers.between 0 255];
      };
...
in
{
  ...
  config = lib.mkIf cfg.enable {
    environment = {
      ...
      systemPackages = [ pkgs.intel-lpmd ];
    };

    services.dbus.packages = [ pkgs.intel-lpmd ];
    systemd.packages = [ pkgs.intel-lpmd ];
  };
}