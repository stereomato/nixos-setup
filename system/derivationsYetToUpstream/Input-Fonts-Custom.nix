...
stdenv.mkDerivation rec {
	...
	src =
		...
		fetchzip {
			...
			# This is the url for the original download. Kept it for the day I want to make this customizable and upstream that
			...
			sha256 = "1i79v6c5jwv80ab7h9fzd5av3fbp0npb6idx7dz8f4dr8xlkapnq";
			stripRoot = false;
	...
	meta = with lib; {
		...
		longDescription = ''
			...
			These ones are customized by L911P according to his own tastes.
		'';
